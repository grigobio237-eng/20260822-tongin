...
const pm = "export const PACKING_MATERIALS = ['특대박스(이불)', '대박스(옷)', '중대박스', '중박스', '소박스', '바구니', '아이스박스', '담요(대)', '담요(중)', '침대비닐커버', '냉장고', '쇼파', '침대', '분해장농', '김치냉장고(대)', '김치냉장고(중)', '세탁기', '건조기', '서랍장', '피아노', '테이프', '에어캡', '랩', 'TV(50인치이하)', 'TV(65~75인치)', 'TV(85인치이상)'];\n";
code = code.replace(pm, ''); // remove from bottom
code = code.replace("];\n\nexport const ROOM_ITEMS", "];\n\n" + pm + "export const ROOM_ITEMS");
code = code.replace("];\r\n\r\nexport const ROOM_ITEMS", "];\r\n\r\n" + pm + "export const ROOM_ITEMS");
