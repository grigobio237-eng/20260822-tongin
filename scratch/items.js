...
exports.OPTION_ITEMS = exports.ROOM_CATEGORIES = exports.UTILITY_ROOM_ITEMS = exports.REAR_BALCONY_ITEMS = exports.VERANDA_ITEMS = exports.KITCHEN_ITEMS = exports.LIVING_ROOM_ITEMS = exports.ROOM_ITEMS = exports.PACKING_MATERIALS = void 0;
// 공통 규격 생성 유틸 (소형/기본/대형)
const createStandardVariants = (small, normal, large) => [
    { name: '소형', cbm: small },
    { name: '일반 (기본)', cbm: normal, isDefault: true },
    { name: '대형', cbm: large },
];
exports.PACKING_MATERIALS = ['특대박스(이불)', '대박스(옷)', '중대박스', '중박스', '소박스', '바구니', '아이스박스', '담요(대)', '담요(중)', '침대비닐커버', '냉장고', '쇼파', '침대', '분해장농', '김치냉장고(대)', '김치냉장고(중)', '세탁기', '건조기', '서랍장', '피아노', '테이프', '에어캡', '랩', 'TV(50인치이하)', 'TV(65~75인치)', 'TV(85인치이상)'];
exports.ROOM_ITEMS = [
    {
        name: '장롱',
        variants: [
    ...
    { name: '기타물품1', variants: exports.PACKING_MATERIALS.map(m => ({ name: m, cbm: 0 })) },
    { name: '기타물품2', variants: exports.PACKING_MATERIALS.map(m => ({ name: m, cbm: 0 })) },
];
exports.LIVING_ROOM_ITEMS = [
    { name: '도서/소형물품(소박스용)', variants: [{ name: '소박스', cbm: 0, isDefault: true }] },
    { name: '생활물품/잔짐류(중박스용)', variants: [{ name: '중박스', cbm: 0, isDefault: true }] },
    {
        name: '쇼파',
    ...
    { name: '탁자', variants: exports.ROOM_ITEMS.find(i => i.name === '탁자').variants },
    { name: '책장', variants: exports.ROOM_ITEMS.find(i => i.name === '책장').variants },
    { name: '책상', variants: exports.ROOM_ITEMS.find(i => i.name === '책상').variants },
    { name: '의자', variants: exports.ROOM_ITEMS.find(i => i.name === '의자').variants },
    { name: 'TV', variants: exports.ROOM_ITEMS.find(i => i.name === 'TV').variants },
    { name: '장식장', variants: exports.ROOM_ITEMS.find(i => i.name === '장식장').variants },
    { name: '에어컨', variants: exports.ROOM_ITEMS.find(i => i.name === '에어컨').variants },
    { name: '콘솔', variants: createStandardVariants(0.5, 0.5, 0.5) },
    { name: '거실장식장', variants: createStandardVariants(0.5, 1, 1.5) },
    { name: '에어드레서/스타일러', variants: exports.ROOM_ITEMS.find(i => i.name === '에어드레서/스타일러').variants },
    { name: '공기청정기', variants: exports.ROOM_ITEMS.find(i => i.name === '공기청정기').variants },
    { name: '기타물품1', variants: exports.PACKING_MATERIALS.map(m => ({ name: m, cbm: 0 })) },
    { name: '기타물품2', variants: exports.PACKING_MATERIALS.map(m => ({ name: m, cbm: 0 })) },
];
exports.KITCHEN_ITEMS = [
    { name: '도서/소형물품(소박스용)', variants: [{ name: '소박스', cbm: 0, isDefault: true }] },
    { name: '생활물품/잔짐류(중박스용)', variants: [{ name: '중박스', cbm: 0, isDefault: true }] },
    {
        name: '식탁',
...
exports.ROOM_CATEGORIES = {
    '안방': exports.ROOM_ITEMS,
    '입구방': exports.ROOM_ITEMS,
    '작은방1': exports.ROOM_ITEMS,
    '작은방2': exports.ROOM_ITEMS,
    '작은방3': exports.ROOM_ITEMS,
    '거실': exports.LIVING_ROOM_ITEMS,
    '주방': exports.KITCHEN_ITEMS,
    '앞 발코니': exports.VERANDA_ITEMS,
    '뒤 발코니': exports.REAR_BALCONY_ITEMS,
    '다용도실 및 현관': exports.UTILITY_ROOM_ITEMS,
};
exports.OPTION_ITEMS = [
