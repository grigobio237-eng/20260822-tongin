...
export default function Step2Page() {
  ...
  return (
    <div className="space-y-6 pb-24 relative">
      ...
      {/* Sticky Container for Tabs and Header */}
              ...
              <div className="space-y-2">
                {instances.length === 0 ? (
                  ...
                  (() => {
                    ...
                    else if (item.name === '식기류') defCbm = materialSettings['바구니'] || 0;
                    else if (item.name === '신발류(중박스용)') defCbm = materialSettings['중박스'] || 0;
                  ...
                  instances.map((inst, idx) => {
                    ...
                    else if (item.name === '식기류') displayCbm = materialSettings['바구니'] || 0;
                    else if (item.name === '신발류(중박스용)') displayCbm = materialSettings['중박스'] || 0;
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-4 overflow-y-auto space-y-3">
              {[...modalState.item.variants].sort((a, b) => a.name.localeCompare(b.name, undefined, { numeric: true })).map((v) => {
                ...
                else if (itemCbmSettings && itemCbmSettings[overrideKey] !== undefined) modalVariantCbm = itemCbmSettings[overrideKey];
                else if (modalState.item.name === '옷') modalVariantCbm = materialSettings['대박스(옷)'] || 0;
                ...
                else if (modalState.item.name === '식기류') modalVariantCbm = materialSettings['바구니'] || 0;
                else if (modalState.item.name === '신발류(중박스용)') modalVariantCbm = materialSettings['중박스'] || 0;
